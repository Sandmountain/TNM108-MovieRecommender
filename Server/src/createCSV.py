...
features = [df_meta['id'],df_meta['original_title'],df_meta['poster_path'], df_meta['overview'],df_meta['budget'],df_meta['genres'],df_meta["release_date"],df_meta["popularity"], df_meta["revenue"]]
...
df.to_csv('trim_movie_database.csv') 
